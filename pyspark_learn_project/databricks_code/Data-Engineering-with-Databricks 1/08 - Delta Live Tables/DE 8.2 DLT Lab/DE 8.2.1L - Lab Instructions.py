...
# MAGIC %fs
# MAGIC mkdirs dbfs:/user/sujeetkumarsingh@live.com/dbacademy/dewd/dlt_lab_82/source/tracker/
...
# MAGIC %fs
# MAGIC ls dbfs:/user/sujeetkumarsingh@live.com/dbacademy/dewd/dlt_lab_82/source/tracker
