...
path = r"dbfs:/mnt/dbacademy-datasets/introduction-to-python-for-data-science-and-data-engineering/v01/sf-airbnb/sf-airbnb.csv".replace("dbfs:/" ,"dbfs/")

# COMMAND ----------

f"{DA.paths.datasets}/sf-airbnb/sf-airbnb.csv".replace("dbfs:", "/dbfs")
